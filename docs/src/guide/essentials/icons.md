...
- 项目的图标主要由`@stall/icons`包提供，建议统一在该包内部管理，以便于统一管理和维护。
...
import { createIconifyIcon } from '@stall-core/icons';
...
import { MdiKeyboardEsc } from '@stall/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@stall/icons';
</script>
