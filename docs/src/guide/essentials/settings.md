...
想要获取 `_app.config.js` 内的变量，需要使用`@stall/hooks`提供的 `useAppConfig`方法。
...
- 首先在 `.env` 或者对应的开发环境配置文件内，新增需要可动态配置的变量，需要以 `VITE_GLOB_*` 开头的变量，如：
  ...
  ```bash
  VITE_GLOB_OTHER_API_URL=https://mock-napi.stall.pro/other-api
  ```
...
const defaultPreferences: Preferences = {
  app: {
    ...
    contentCompact: 'wide',
    defaultAvatar:
      'https://unpkg.com/@stalljs/static-source@0.1.7/source/avatar-v1.webp',
    dynamicTitle: true,
  ...
  copyright: {
    companyName: 'Stall',
    companySiteLink: 'https://www.stall.pro',
    date: '2024',
    enable: true,
    icp: '',
    icpLink: '',
