...
import { updatePreferences } from '@stall/preferences';
...
- 请不要将业务翻译文本放到 `@stall/locales` 内，这样可以更好的管理业务和通用的翻译文本。
...
{
  "about": {
    "desc": "Stall Admin is a modern management template."
  }
}
````
...
通过 `@stall/locales`，你可以很方便的使用翻译文本：
