import { IPublicTypeNpmInfo } from '@stall-lowcode/types';
    ...
    .reduce(
      (utils, meta) => {
        ...
        if (type === 'npm') {
          ...
          utils[name] = isJSFunction(content) ? new Function(`return ${content.value}`)() : meta.content;
        }
