...
import type { Component, ComponentPublicInstance, DefineComponent, ExtractPropTypes, PropType } from 'vue';
...
export const rendererProps = {
  ...
  __triggerCompGetCtx: {
    type: Function as PropType<(schema: NodeSchema, ref: ComponentPublicInstance) => void>,
    required: true,
  },
  __thisRequiredInJSE: {
    type: Boolean,
