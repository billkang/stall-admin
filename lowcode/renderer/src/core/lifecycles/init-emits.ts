...
export function initEmits(parser: SchemaParser, schema: unknown, scope: RuntimeScope): void {
  ...
  scope.$.emitsOptions = Object.create(scope.$.emitsOptions, Object.getOwnPropertyDescriptors(dataResult));
}
