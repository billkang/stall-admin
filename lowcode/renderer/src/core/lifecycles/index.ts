import type { IPublicTypeContainerSchema } from '@stall-lowcode/types';
...
export function createHookCaller(schema: IPublicTypeContainerSchema, scope: RuntimeScope, parser: SchemaParser) {
  ...
  function callHook<T extends LowCodeHook>(hook: T, param1?: object, param2?: object): void | Promise<void> {
