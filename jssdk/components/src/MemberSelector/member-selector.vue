...
import { PropType, ref, inject, watch, onBeforeMount } from 'vue';
import { InputTag, Button } from 'stall-design';
...
<style lang="less">
@import url('stall-design/es/style/index.less');
@import url('stall-design/es/input-tag/style/index.less');
@import url('stall-design/es/button/style/index.less');

.stallll-jssdk__member-selector-container {
  width: 100%;
