...
import type { TabDefinition } from '@stall-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@stall-core/icons';
import { StallContextMenu, StallIcon } from '@stall-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
  name: 'StallTabsChrome',
  // eslint-disable-next-line perfectionist/sort-objects
  inheritAttrs: false,
});

const props = withDefaults(defineProps<Props>(), {
  contentClass: 'stall-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
