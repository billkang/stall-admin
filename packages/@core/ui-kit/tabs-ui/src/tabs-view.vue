...
import { useForwardPropsEmits } from '@stall-core/composables';
import { ChevronLeft, ChevronRight } from '@stall-core/icons';
import { StallScrollbar } from '@stall-core/shadcn-ui';
