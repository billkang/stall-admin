...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@stall-core/composables';
import { X } from '@stall-core/icons';
import {
  Separator,
  Sheet,
  SheetClose,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@stall-core/shared/constants';
  ...
  >
    ...
    >
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <StallHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </StallHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <div
        ...
        "
      >
        <StallLoading v-if="showLoading" class="size-full" spinning />
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || StallButton"
          ...
          <component
            :is="components.PrimaryButton || StallButton"
