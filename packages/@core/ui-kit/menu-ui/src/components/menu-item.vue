...
import { useNamespace } from '@stall-core/composables';
import { StallIcon, StallTooltip } from '@stall-core/shadcn-ui';
  ...
  >
    ...
    >
      <template #trigger>
        <div :class="[nsMenu.be('tooltip', 'trigger')]">
          <StallIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
          <slot></slot>
    ...
    <div v-show="!showTooltip" :class="[e('content')]">
      <MenuBadge
        ...
        v-bind="props"
      />
      <StallIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
      <slot></slot>
      <slot name="title"></slot>
    </div>
  </li>
