...
import type { StallLayoutProps } from './stall-layout';
...
import { Menu } from '@stall-core/icons';
import { StallIconButton } from '@stall-core/shadcn-ui';
...
interface Props extends StallLayoutProps {}
