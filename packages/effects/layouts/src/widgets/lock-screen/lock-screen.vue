...
import { LockKeyhole } from '@stall/icons';
import { $t, useI18n } from '@stall/locales';
import { storeToRefs, useLockStore } from '@stall/stores';

import { useScrollLock } from '@stall-core/composables';
import { useStallForm, z } from '@stall-core/form-ui';
import { StallAvatar, StallButton } from '@stall-core/shadcn-ui';
...
const [Form, { form, validate }] = useStallForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'StallInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[300px]">
          <StallAvatar :src="avatar" class="enter-x mb-6 size-20" />

          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <StallButton class="enter-x w-full" @click="handleSubmit">
