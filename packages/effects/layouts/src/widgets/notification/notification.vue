...
import { Bell, MailCheck } from '@stall/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <StallIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <StallScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <StallButton size="sm" @click="handleViewAll">
