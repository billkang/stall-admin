...
import type { SegmentedItem } from '@stall-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '@stall/icons';
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <StallSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
