...
export let useTableForm: typeof useStallForm;
...
export function setupStallVxeTable(setupOptions: SetupVxeTable) {
  const { configVxeTable, useStallForm } = setupOptions;

  initVxeTable();
  useTableForm = useStallForm;
